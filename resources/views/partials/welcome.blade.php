...
<div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover left-half" style="background-image: url('{{asset('assets/img/bg/bg10.jpg')}}');">
...
<div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover right-half" style="background-image: url('{{asset('assets/img/bg/bg5.jpg')}}');">
