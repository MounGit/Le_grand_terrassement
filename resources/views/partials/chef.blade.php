        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="{{asset('assets/img/bg/bg4.jpg')}}" data-speed="0.8">
                                ...
                                <ul class="owl-carousel-paged testimonial-owl wow fadeIn list-unstyled" data-items="3" data-items-tablet="[768,2]" data-items-mobile="[479,1]">
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="{{asset('assets/img/team/1.jpg')}}" class="img-responsive smoothie" alt="">
                                            </div>
                                    ...
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="{{asset('assets/img/team/2.jpg')}}" class="img-responsive smoothie" alt="">
                                            </div>
                                            <div class="col-xs-12 overlay-item-caption smoothie"></div>
                                            <div class="col-xs-12 hover-item-caption smoothie">
                                                <div class="vertical-center">
